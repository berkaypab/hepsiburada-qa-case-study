...
Bu tarz dinamik (ve zamanla güncellenen) makine öğrenimi mantığına sahip sıralama fonksiyonları için geleneksel "DOM üzerindeki element sırasını (1., 2., 3.) assertion et" yaklaşımı aşırı _flaky_ (kırılgan) testlere sebep olacaktır. Kaliteden emin olmak için aşağıdaki yaklaşımlar tavsiye edilir:
